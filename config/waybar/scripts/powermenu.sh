...
-theme-str "window { location: center; anchor: center; width: 15%; border: 2px; border-color: $BORDE; border-radius: 10px; background-color: $FONDO; padding: 15px; }" \
-theme-str "inputbar { enabled: false; }" \
-theme-str "listview { lines: 4; scrollbar: false; background-color: transparent; margin: 0; }" \
-theme-str "element { padding: 8px; border-radius: 5px; background-color: transparent; }" \
